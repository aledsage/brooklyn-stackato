...
public class StackatoNodeImpl extends SoftwareProcessImpl implements StackatoNode {

    private static final Logger log = LoggerFactory.getLogger(StackatoNode.class);
    
    public StackatoNodeImpl() {
    }

    public StackatoNodeImpl(Entity parent) {
    	super(parent);
    }

    public StackatoNodeImpl(Map flags, Entity parent) {
    	super(flags, parent);
    }
    ...
    protected StackatoDeployment getStackatoDeployment() {
        Entity stackatoCluster = getParent();
        while (!(stackatoCluster instanceof StackatoDeployment)) {
            ...
            stackatoCluster = stackatoCluster.getParent();
        }
